...
class SurfacesMat
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="rubriques", type="string", length=255, nullable=true)
     */
    private $rubriques;
     ...
     * @var string|null
     *
     * @ORM\Column(name="sous_rubriques", type="string", length=255, nullable=true)
     */
    ...
    public function setRubriques(?string $rubriques): self
    {
    ...
    public function getSousRubriques(): ?string
    {
        return $this->sousRubriques;
    }

    public function setSousRubriques(?string $sousRubriques): self
    {
